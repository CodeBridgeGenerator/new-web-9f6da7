...
import SingleProjectIDPage from "../components/ProjectIDPage/SingleProjectIDPage";
import ProjectIDProjectLayoutPage from "../components/ProjectIDPage/ProjectIDProjectLayoutPage";
import SingleProjectNamePage from "../components/ProjectNamePage/SingleProjectNamePage";
import ProjectNameProjectLayoutPage from "../components/ProjectNamePage/ProjectNameProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/projectID/:singleProjectIDId" exact element={<SingleProjectIDPage />} />
<Route path="/projectID" exact element={<ProjectIDProjectLayoutPage />} />
<Route path="/projectName/:singleProjectNameId" exact element={<SingleProjectNamePage />} />
<Route path="/projectName" exact element={<ProjectNameProjectLayoutPage />} />
