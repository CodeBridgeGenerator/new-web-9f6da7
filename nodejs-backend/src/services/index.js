...
const projectID = require("./projectID/projectID.service.js");
const projectName = require("./projectName/projectName.service.js");
...
module.exports = function (app) {
  ...
  app.configure(projectID);
  app.configure(projectName);
